...
public class DataInitializer implements CommandLineRunner {
    ...
    private void initializeSampleCourses() {
        ...
        course1.setAcademicYear("2024-2025");
        course1.setStartDate(java.time.LocalDate.of(2024, 9, 1));
        course1.setEndDate(java.time.LocalDate.of(2024, 12, 15));
        ...
        course1.setLearningObjectives("Understand basic programming concepts, problem-solving skills, algorithmic thinking");
        ...
        course2.setLevel(Course.CourseLevel.INTERMEDIATE);
        course2.setInstructor("Dr. Bob Smith");
        course2.setSemester("Fall 2024");
        course2.setAcademicYear("2024-2025");
        course2.setStartDate(java.time.LocalDate.of(2024, 9, 1));
        course2.setEndDate(java.time.LocalDate.of(2024, 12, 15));
        ...
        course2.setLearningObjectives("Master data structures, analyze algorithm complexity, implement efficient solutions");
        ...
        course3.setLevel(Course.CourseLevel.BEGINNER);
        course3.setInstructor("Prof. Carol Davis");
        course3.setSemester("Fall 2024");
        course3.setAcademicYear("2024-2025");
        course3.setStartDate(java.time.LocalDate.of(2024, 9, 1));
        course3.setEndDate(java.time.LocalDate.of(2024, 12, 15));
        course3.setMaxStudents(40);
        course3.setCurrentEnrollment(35);
        course3.setStatus(Course.CourseStatus.ACTIVE);
        course3.setPrerequisites("None");
        course3.setLearningObjectives("Understand business fundamentals, marketing concepts, financial basics");
        ...
        course4.setLevel(Course.CourseLevel.ADVANCED);
        course4.setInstructor("Dr. David Wilson");
        course4.setSemester("Fall 2024");
        course4.setAcademicYear("2024-2025");
        course4.setStartDate(java.time.LocalDate.of(2024, 9, 1));
        course4.setEndDate(java.time.LocalDate.of(2024, 12, 15));
        course4.setMaxStudents(20);
        course4.setCurrentEnrollment(15);
        course4.setStatus(Course.CourseStatus.ACTIVE);
        course4.setPrerequisites("ENG201, ENG202");
        course4.setLearningObjectives("Design mechanical systems, apply engineering principles, use CAD software");
